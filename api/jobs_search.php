<?php
// api/jobs_search.php — AJAX endpoint (XMLHttpRequest) used by job search filters
// Returns JSON. No HTML output. Requires active session.
...
// Return only necessary fields for the frontend card render
