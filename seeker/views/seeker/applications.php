...
<div class="container">
    ...
    <?php if (empty($applications)): ?>
        <p class="muted">You haven't applied to any jobs yet. <a href="/job_portal/seeker/index.php?action=jobs">Browse jobs →</a></p>
    <?php else: ?>
    <table class="data-table">
        ...
        <?php foreach ($applications as $app): ?>
            <tr>
                <td><a href="/job_portal/seeker/index.php?action=jobDetail&id=<?= (int)$app['job_id'] ?>"><?= htmlspecialchars($app['job_title']) ?></a></td>
                ...
                <td>
                    <?php if ($app['status'] === 'submitted'): ?>
                        <form method="post" action="/job_portal/seeker/index.php?action=withdraw"
