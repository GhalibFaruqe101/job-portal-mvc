    ...
    <div class="two-col">
        ...
        <section class="card">
            ...
            <?php if (empty($applications)): ?>
                <p class="muted">No applications yet. <a href="/job_portal/seeker/index.php?action=jobs">Find jobs →</a></p>
            <?php else: ?>
                <ul class="app-list">
                ...
                <a href="/job_portal/seeker/index.php?action=applications">View all →</a>
            <?php endif; ?>
        </section>
        ...
        <section class="card">
            ...
            <?php if (empty($matchedJobs)): ?>
                <p class="muted">No matches yet. <a href="/job_portal/seeker/index.php?action=alerts">Set up alerts →</a></p>
            <?php else: ?>
                <ul class="app-list">
                    <?php foreach ($matchedJobs as $job): ?>
                    <li>
                        <a href="/job_portal/seeker/index.php?action=jobDetail&id=<?= (int)$job['id'] ?>">
