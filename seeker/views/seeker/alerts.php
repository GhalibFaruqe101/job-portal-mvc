...
<div class="container">
    ...
    <section class="card">
        ...
        <form method="post" action="/job_portal/seeker/index.php?action=createAlert" class="inline-form">
    ...
    <section class="card">
        ...
        <table class="data-table">
            ...
            <tr>
                ...
                <td>
                    <form method="post" action="/job_portal/seeker/index.php?action=deleteAlert"
