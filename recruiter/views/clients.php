...
<body>
    ...
    <main class="clients-main">
        <div class="page-header">
            ...
            <button class="btn-add-client" onclick="document.getElementById('addClientModal').style.display='flex'">+
                Add Client</button>
        </div>
                            ...
                            <?php if (!empty($c['website'])): ?>
                                <p>
                                    ...
                                    <a href="<?php echo htmlspecialchars($c['website']); ?>" target="_blank"
                                        style="color: #8b5cf6;">Website</a>
                                </p>
                            <?php endif; ?>
                        </div>
                        <div class="client-footer">
                            <span class="active-jobs"><?php echo $c['active_jobs']; ?> Active
                                Job<?php echo $c['active_jobs'] != 1 ? 's' : ''; ?></span>
        ...
        <div class="modal-card">
            <div class="modal-header">
                ...
                <button class="modal-close"
                    onclick="document.getElementById('addClientModal').style.display='none'">&times;</button>
            </div>
