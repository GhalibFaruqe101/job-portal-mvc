<?php
// views/seeker/jobs.php — Job listings with AJAX-powered filters
// NO business logic here. $jobs, $categories, $filters come from controller.
define('BASE_URL', '../');
$pageTitle = 'Find Jobs';
$activeNav = 'jobs';
...
<div class="container">
    ...
    <!-- Job Cards Container (re-rendered by AJAX) -->
...
<script>
// AJAX job filter — uses XMLHttpRequest as required
let debounceTimer;
    ...
    container.innerHTML = jobs.map(j => `
        <div class="job-card ${j.is_featured ? 'featured' : ''}">
            <div class="job-card-top">
                ...
                <div>
                    <a href="index.php?action=jobDetail&id=${j.id}" class="job-title">${escHtml(j.title)}</a>
            ...
            <div class="job-card-footer">
                ...
                <a href="index.php?action=jobDetail&id=${j.id}" class="btn-sm">View &amp; Apply</a>
            </div>
        </div>
    `).join('');
}
